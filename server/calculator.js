 ...
 */
function calculateBMR_MifflinStJeor(weight, height, age, sex) {
 ...
 */
function calculateBMR_KatchMcArdle(weight, bodyFatPercentage) {
 ...
 */
function getActivityMultiplier(trainingFrequency, trainingIntensity) {
 ...
 */
function getCalorieAdjustment(goal, approach) {
    if (goal === 'weight_loss') {
        // Déficit calórico
 ...
 */
function calculateMacroDistribution(targetCalories, weight, goal, approach, trainingIntensity) {
...
export function calculateMacros(input) {
    ...
    // Calcular macros
    const macros = calculateMacroDistribution(targetCalories, input.weight, input.goal, input.approach, input.trainingIntensity);
